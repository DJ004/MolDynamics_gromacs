...
# To use GMX with GPU
cmake .. -DGMX_GPU=CUDA -DGMX_BUILD_OWN_FFTW=ON -DREGRESSIONTEST_DOWNLOAD=ON -DCUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda-11.2 #-DGMX_CUDA_TARGET_COMPUTE=12.0
...
- This issue does not exist with GROMACS 2021.3.
  - Successful installation of GPU-enabled GROMACS 🎉
  - Tested with `gmx mdrun -v -deffnm test -nb gpu -bonded gpu`
